  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: selected ? const Color(0xFFEAF7FA) : Colors.white,
          borderRadius: BorderRadius.circular(999),
          border: Border.all(
            color: selected ? const Color(0xFF268B9C) : const Color(0xFFDDE5EA),
          ),
        ),
        child: Text(
          label,
          style: TextStyle(
            color: selected ? const Color(0xFF195F6C) : const Color(0xFF5A6370),
            fontSize: 12.4,
            fontWeight: FontWeight.w800,
          ),
        ),
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: const LinearGradient(
          colors: [Color(0xFFEDF9FB), Color(0xFFFFFFFF)],
          begin: Alignment.topLeft,
          end: Alignment.bottomRight,
        ),
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 4),
          const Text(
            'Quick picks from this pharmacy',
            style: TextStyle(
                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          color: outOfStock ? const Color(0xFF9AA1AD) : const Color(0xFF268B9C),
                          fontSize: 10.8,
                          fontWeight: FontWeight.w900,
                        ),
                      ),
